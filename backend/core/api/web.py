...
from apps.community.api.endpoints import router as community_api_router
...
web_app.add_router("/community/", community_web_router)
...
web_app.add_router("/api/community/", community_api_router)
